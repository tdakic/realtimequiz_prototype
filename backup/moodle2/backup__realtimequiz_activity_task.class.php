...
/**
 * Defines backup_realtimequiz_activity_task class
 *
...
class backup_realtimequiz_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        // Generate the realtimequiz.xml file containing all the realtimequiz information
        // and annotating used questions.
        $this->add_step(new backup_realtimequiz_activity_structure_step('realtimequiz_structure', 'realtimequiz.xml'));

        // Note: Following  steps must be present
        // in all the activities using question banks (only realtimequiz for now)
    ...
    public static function encode_content_links($content) {
        ...
        // Link to realtimequiz view by realtimequizid.
        $search="/(".$base."\/mod\/realtimequiz\/view.php\?q\=)([0-9]+)/";
