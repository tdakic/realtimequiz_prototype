...
namespace realtimequizaccess_delaybetweenattempts;

use mod_realtimequiz\realtimequiz_settings;
use realtimequizaccess_delaybetweenattempts;

defined('MOODLE_INTERNAL') || die();

global $CFG;
require_once($CFG->dirroot . '/mod/realtimequiz/accessrule/delaybetweenattempts/rule.php');


/**
 * Unit tests for the realtimequizaccess_delaybetweenattempts plugin.
 *
...
class rule_test extends \basic_testcase {
    public function test_just_first_delay() {
        ...
        $realtimequiz->attempts = 3;
        $realtimequiz->timelimit = 0;
        $realtimequiz->delay1 = 1000;
        $realtimequiz->delay2 = 0;
        ...
        $rule = new realtimequizaccess_delaybetweenattempts($realtimequizobj, 10000);
        ...
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(11000)));
        ...
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(10001)));
        $this->assertFalse($rule->prevent_new_attempt(2, $attempt));
    }

    public function test_just_second_delay() {
        $realtimequiz = new \stdClass();
        $realtimequiz->attempts = 5;
        $realtimequiz->timelimit = 0;
        $realtimequiz->delay1 = 0;
        $realtimequiz->delay2 = 1000;
        $realtimequiz->timeclose = 0;
        $cm = new \stdClass();
        $cm->id = 0;
        $realtimequizobj = new realtimequiz_settings($realtimequiz, $cm, null);
    ...
    public function test_just_both_delays() {
        ...
        $this->assertFalse($rule->prevent_new_attempt(5, $attempt));
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(12000)));
        $this->assertEquals($rule->prevent_new_attempt(2, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(11000)));
        $this->assertEquals($rule->prevent_new_attempt(3, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(11000)));
        ...
        $attempt->timefinish = 9001;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(11001)));
        $this->assertEquals($rule->prevent_new_attempt(2, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(10001)));
        $this->assertEquals($rule->prevent_new_attempt(4, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(10001)));
    ...
    public function test_with_close_date() {
        ...
        $attempt->timefinish = 13000;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youmustwait', 'realtimequizaccess_delaybetweenattempts', userdate(15000)));
        $attempt->timefinish = 13001;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
            get_string('youcannotwait', 'realtimequizaccess_delaybetweenattempts'));
        ...
        $rule = new realtimequizaccess_delaybetweenattempts($realtimequizobj, 15000);
        $attempt->timefinish = 13000;
        $this->assertFalse($rule->prevent_new_attempt(1, $attempt));
        $attempt->timefinish = 13001;
        $this->assertEquals($rule->prevent_new_attempt(1, $attempt),
        ...
        $rule = new realtimequizaccess_delaybetweenattempts($realtimequizobj, 15001);
        $attempt->timefinish = 13000;
        $this->assertFalse($rule->prevent_new_attempt(1, $attempt));
        $attempt->timefinish = 13001;
        $this->assertFalse($rule->prevent_new_attempt(1, $attempt));
