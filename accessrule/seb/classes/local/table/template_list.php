...
namespace realtimequizaccess_seb\local\table;

use realtimequizaccess_seb\helper;
use realtimequizaccess_seb\template;
use realtimequizaccess_seb\template_controller;
...
class template_list extends \flexible_table {
    ...
    public function __construct($id = null) {
        ...
        parent::__construct('realtimequizaccess_seb' . $id);
        ...
        $this->define_headers([
            get_string('name', 'realtimequizaccess_seb'),
            get_string('description', 'realtimequizaccess_seb'),
            get_string('enabled', 'realtimequizaccess_seb'),
            get_string('used', 'realtimequizaccess_seb'),
            get_string('actions'),
        ]);
     ...
     * Display name column.
     *
     * @param \realtimequizaccess_seb\template $data Template for this row.
     * @return string
     */
     ...
     *
     * @param \realtimequizaccess_seb\template[] $records An array with records.
     */
