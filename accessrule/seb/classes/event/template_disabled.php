...
class template_disabled extends base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'rtqaccess_seb_template';
        $this->data['crud'] = 'u';
    ...
    public static function get_name() {
        return get_string('event:templatedisabled', 'realtimequizaccess_seb');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/realtimequiz/accessrule/seb/template.php', $params);
    }
    ...
    public static function get_objectid_mapping() : array {
        return ['db' => 'rtqaccess_seb_template', 'restore' => 'rtqaccess_seb_template'];
    }
