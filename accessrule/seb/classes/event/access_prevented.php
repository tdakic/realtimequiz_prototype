...
/**
 * Event for when access to a realtimequiz is prevented by this subplugin.
 *
...
class access_prevented extends base {
    ...
    public static function create_strict(seb_access_manager $accessmanager, string $reason,
        ...
        return self::create([
            'userid' => $USER->id,
            'objectid' => $accessmanager->get_realtimequiz()->get_realtimequizid(),
            'courseid' => $accessmanager->get_realtimequiz()->get_courseid(),
            'context' => $accessmanager->get_realtimequiz()->get_context(),
            'other' => $other,
        ]);
    }
    ...
    public static function get_name() {
        return get_string('event:accessprevented', 'realtimequizaccess_seb');
    }
    ...
    public function get_description() {
        $description = "The user with id '$this->userid' has been prevented from accessing realtimequiz with id '$this->objectid' by the "
