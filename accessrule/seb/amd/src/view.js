...
/**
 * Manage the realtimequiz views.
 *
 * @module     realtimequizaccess_seb/view
...
const TEMPLATE = {
    LOADING: 'realtimequizaccess_seb/loading',
};
...
export const showValidationFailedModal = () => {
    ModalFactory.create({
        ...
        title: Str.get_string('sebkeysvalidationfailed', 'realtimequizaccess_seb'),
        body: Str.get_string('invalidkeys', 'realtimequizaccess_seb'),
        large: false,
    }).then((modal) => {
        modal.show();
