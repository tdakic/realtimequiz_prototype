...
class link_generator_test extends \advanced_testcase {
    ...
    public function test_http_link_generated() {
        ...
        $this->assertEquals(
            "http://www.example.com/moodle/mod/realtimequiz/accessrule/seb/config.php?cmid=$realtimequiz->cmid",
            link_generator::get_link($realtimequiz->cmid, false, false));
    }
    ...
    public function test_https_link_generated() {
        ...
        $this->assertEquals(
            "https://www.example.com/moodle/mod/realtimequiz/accessrule/seb/config.php?cmid=$realtimequiz->cmid",
            link_generator::get_link($realtimequiz->cmid, false));
    }
    ...
    public function test_seb_link_generated() {
        ...
        $this->assertEquals(
            "seb://www.example.com/moodle/mod/realtimequiz/accessrule/seb/config.php?cmid=$realtimequiz->cmid",
            link_generator::get_link($realtimequiz->cmid, true, false));
    }
    ...
    public function test_sebs_link_generated() {
        ...
        $this->assertEquals(
            "sebs://www.example.com/moodle/mod/realtimequiz/accessrule/seb/config.php?cmid=$realtimequiz->cmid",
            link_generator::get_link($realtimequiz->cmid, true));
    }
