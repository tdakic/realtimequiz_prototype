...
/**
 * Strings for the realtimequizaccess_seb plugin.
 *
...
$string['cachedef_realtimequizsettings'] = 'SEB realtimequiz settings cache';
$string['cantdelete'] = 'The template can\'t be deleted as it has been used for one or more realtimequizzes.';
$string['cantedit'] = 'The template can\'t be edited as it has been used for one or more realtimequizzes.';
$string['checkingaccess'] = 'Checking access to Safe Exam Browser...';
$string['clientrequiresseb'] = 'This realtimequiz has been configured to use the Safe Exam Browser with client configuration.';
...
$string['disabledsettings_help'] = 'Safe Exam Browser realtimequiz settings can\'t be changed if the realtimequiz has been attempted. To change a setting, all realtimequiz attempts must first be deleted.';
...
$string['error:ws:realtimequiznotexists'] = 'Quiz not found matching course module ID: {$a}';
...
$string['filemanager_sebconfigfile_help'] = 'Please upload your own Safe Exam Browser config file for this realtimequiz.';
...
$string['noconfigfilefound'] = 'No uploaded SEB config file could be found for realtimequiz with cmid: {$a}';
$string['noconfigfound'] = 'No SEB config could be found for realtimequiz with cmid: {$a}';
$string['not_seb'] = 'No Safe Exam Browser is being used.';
$string['notemplate'] = 'No template';
$string['passwordnotset'] = 'Current settings require realtimequizzes using the Safe Exam Browser to have a realtimequiz password set.';
$string['pluginname'] = 'Safe Exam Browser access rules';
$string['privacy:metadata:rtqaccess_seb_rtqsettings'] = 'Safe Exam Browser settings for a realtimequiz. This includes the ID of the last user to create or modify the settings.';
$string['privacy:metadata:rtqaccess_seb_rtqsettings:realtimequizid'] = 'ID of the realtimequiz the settings exist for.';
$string['privacy:metadata:rtqaccess_seb_rtqsettings:timecreated'] = 'Unix time that the settings were created.';
$string['privacy:metadata:rtqaccess_seb_rtqsettings:timemodified'] = 'Unix time that the settings were last modified.';
$string['privacy:metadata:rtqaccess_seb_rtqsettings:usermodified'] = 'ID of user who last created or modified the settings.';
$string['privacy:metadata:rtqaccess_seb_template'] = 'Safe Exam Browser template settings. This includes the ID of the last user to create or modify the template.';
$string['privacy:metadata:rtqaccess_seb_template:timecreated'] = 'Unix time that the template was created.';
$string['privacy:metadata:rtqaccess_seb_template:timemodified'] = 'Unix time that the template was last modified.';
$string['privacy:metadata:rtqaccess_seb_template:usermodified'] = 'ID of user who last created or modified the template.';
$string['realtimequizsettings'] = 'Quiz settings';
$string['restoredfrom'] = '{$a->name} (restored via cmid {$a->cmid})';
$string['seb'] = 'Safe Exam Browser';
$string['seb:bypassseb'] = 'Bypass the requirement to view realtimequiz in Safe Exam Browser.';
$string['seb:manage_filemanager_sebconfigfile'] = 'Change SEB realtimequiz setting: Select SEB config file';
$string['seb:manage_seb_activateurlfiltering'] = 'Change SEB realtimequiz setting: Activate URL filtering';
$string['seb:manage_seb_allowedbrowserexamkeys'] = 'Change SEB realtimequiz setting: Allowed browser exam keys';
$string['seb:manage_seb_allowreloadinexam'] = 'Change SEB realtimequiz setting: Allow reload';
$string['seb:manage_seb_allowspellchecking'] = 'Change SEB realtimequiz setting: Enable spell checking';
$string['seb:manage_seb_allowuserquitseb'] = 'Change SEB realtimequiz setting: Allow quit';
$string['seb:manage_seb_enableaudiocontrol'] = 'Change SEB realtimequiz setting: Enable audio control';
$string['seb:manage_seb_expressionsallowed'] = 'Change SEB realtimequiz setting: Simple expressions allowed';
$string['seb:manage_seb_expressionsblocked'] = 'Change SEB realtimequiz setting: Simple expressions blocked';
$string['seb:manage_seb_filterembeddedcontent'] = 'Change SEB realtimequiz setting: Filter embedded content';
$string['seb:manage_seb_linkquitseb'] = 'Change SEB realtimequiz setting: Quit link';
$string['seb:manage_seb_muteonstartup'] = 'Change SEB realtimequiz setting: Mute on startup';
$string['seb:manage_seb_quitpassword'] = 'Change SEB realtimequiz setting: Quit password';
$string['seb:manage_seb_regexallowed'] = 'Change SEB realtimequiz setting: Regex expressions allowed';
$string['seb:manage_seb_regexblocked'] = 'Change SEB realtimequiz setting: Regex expressions blocked';
$string['seb:manage_seb_requiresafeexambrowser'] = 'Change SEB realtimequiz setting: Require Safe Exam Browser';
$string['seb:manage_seb_showkeyboardlayout'] = 'Change SEB realtimequiz setting: Show keyboard layout';
$string['seb:manage_seb_showreloadbutton'] = 'Change SEB realtimequiz setting: Show reload button';
$string['seb:manage_seb_showsebtaskbar'] = 'Change SEB realtimequiz setting: Show task bar';
$string['seb:manage_seb_showtime'] = 'Change SEB realtimequiz setting: Show time';
$string['seb:manage_seb_showwificontrol'] = 'Change SEB realtimequiz setting: Show Wi-Fi control';
$string['seb:manage_seb_showsebdownloadlink'] = 'Change SEB realtimequiz setting: Show download link';
$string['seb:manage_seb_templateid'] = 'Change SEB realtimequiz setting: Select SEB template';
$string['seb:manage_seb_userconfirmquit'] = 'Change SEB realtimequiz setting: Confirm on quit';
...
$string['seb_allowedbrowserexamkeys_help'] = 'In this field you can enter the allowed browser exam keys for versions of Safe Exam Browser that are permitted to access this realtimequiz. If no keys are entered, then browser exam keys are not checked.';
...
$string['seb_help'] = 'Setup realtimequiz to use the Safe Exam Browser.';
...
$string['seb_requiresafeexambrowser_help'] = 'If enabled, students can only attempt the realtimequiz using the Safe Exam Browser.
The available options are:

* No
<br/>Safe Exam Browser is not required to attempt the realtimequiz.
...
<br/>No configurations of Safe Exam Browser are on the Moodle side. The realtimequiz can be attempted with any configuration of Safe Exam Browser.';
...
$string['seb_showsebdownloadlink_help'] = 'If enabled, a button for Safe Exam Browser download will be shown on the realtimequiz start page.';
$string['seb_templateid'] = 'Safe Exam Browser config template';
$string['seb_templateid_help'] = 'The settings in the selected config template will be used for the configuration of the Safe Exam Browser while attempting the realtimequiz. You may overwrite the settings in the template with your manual settings.';
...
$string['sebrequired'] = "This realtimequiz has been configured so that students may only attempt it using the Safe Exam Browser.";
$string['setting:autoreconfigureseb'] = 'Auto-configure SEB';
$string['setting:autoreconfigureseb_desc'] = 'If enabled, users who navigate to the realtimequiz using the Safe Exam Browser will be automatically forced to reconfigure their Safe Exam Browser.';
$string['setting:displayblocksbeforestart'] = 'Display blocks before starting realtimequiz';
$string['setting:displayblocksbeforestart_desc'] = 'If enabled, blocks will be displayed before a user attempts the realtimequiz.';
$string['setting:displayblockswhenfinished'] = 'Display blocks after finishing realtimequiz';
$string['setting:displayblockswhenfinished_desc'] = 'If enabled, blocks will be displayed after a user has finished their realtimequiz attempt.';
...
$string['setting:realtimequizpasswordrequired'] = 'Quiz password required';
$string['setting:realtimequizpasswordrequired_desc'] = 'If enabled, all realtimequizzes that require the Safe Exam Browser must have a realtimequiz password set.';
...
$string['setting:showseblinks_desc'] = 'Whether to show links for a user to access the Safe Exam Browser configuration file when access to the realtimequiz is prevented. Note that seb:// links may not work in every browser.';
...
$string['settingsfrozen'] = 'Due to there being at least one realtimequiz attempt, the Safe Exam Browser settings can no longer be updated.';
