...
$string['accessnoticesheader'] = 'You can preview this realtimequiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have realtimequizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the realtimequiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the realtimequiz. This means that different students are likely to get a different selection of questions, and when a realtimequiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any realtimequiz in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your realtimequiz over on the other side of this page.</p>';
...
$string['addquestionstorealtimequiz'] = 'Add questions to current realtimequiz';
...
$string['addrandomquestiontorealtimequiz'] = 'Add a random question to realtimequiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstorealtimequiz'] = 'Add selected questions to the realtimequiz';
$string['addselectedtorealtimequiz'] = 'Add selected to realtimequiz';
$string['addtorealtimequiz'] = 'Add to realtimequiz';
...
$string['attempterror'] = 'You are not allowed to attempt this realtimequiz at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid realtimequiz attempt ID';
$string['attempterrorcontentchange'] = 'This realtimequiz preview no longer exists. (When a realtimequiz is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This realtimequiz attempt no longer exists.';
...
$string['attemptrealtimequiznow'] = 'Attempt realtimequiz now';
$string['attemptrealtimequiz'] = 'Attempt realtimequiz';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during realtimequiz attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtorealtimequiz'] = 'Back to realtimequiz editing';
...
* The realtimequiz will only start if the student has a JavaScript-enabled web-browser
* The realtimequiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this realtimequiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the realtimequiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this realtimequiz. The realtimequiz is set to be graded out of {$a->grade}, but none of the questions in the realtimequiz have a grade. This can be fixed on the \'Edit realtimequiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this realtimequiz. The realtimequiz definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this realtimequiz. The realtimequiz has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, after finishing attempting a question, a \'Try another question like this one\' button is displayed. This allows for a similar question (selected randomly) to be attempted, or the same question again, without the entire realtimequiz attempt having to be submitted and another attempt started. This option is useful for practice realtimequizzes.
...
$string['closebeforeopen'] = 'Could not update the realtimequiz. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark realtimequiz complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the realtimequiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the realtimequiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the realtimequiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a realtimequiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the realtimequiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new realtimequiz. You can also configure which realtimequiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the realtimequiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the realtimequiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the realtimequiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during realtimequiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the realtimequiz.';
$string['configrequiresubnet'] = 'Students can only attempt the realtimequiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a realtimequiz attempt or look at the realtimequiz reports.';
$string['configshowblocks'] = 'Show blocks during realtimequiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this realtimequiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for realtimequizzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for realtimequizzes in seconds. 0 mean no time limit.';
...
$string['continueattemptrealtimequiz'] = 'Continue your attempt';
...
$string['countdownfinished'] = 'The realtimequiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The realtimequiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to realtimequiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the realtimequiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the realtimequiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the realtimequiz a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/realtimequiz folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new realtimequiz attempt will contain the results of the previous attempt. This allows a realtimequiz to be completed over several attempts.';
...
$string['editingrealtimequiz'] = 'Editing realtimequiz';
$string['editingrealtimequiz_help'] = 'When creating a realtimequiz, the main concepts are:

* The realtimequiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the realtimequiz and different students can get different questions';
$string['editingrealtimequiz_link'] = 'mod/realtimequiz/edit';
$string['editingrealtimequizx'] = 'Editing realtimequiz: {$a}';
...
$string['editrealtimequiz'] = 'Edit realtimequiz';
$string['editrealtimequizquestions'] = 'Edit realtimequiz questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->realtimequizname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this realtimequiz at {$a->realtimequizurl}.';
$string['emailconfirmbodyautosubmit'] = 'Hi {$a->username},

The time for the realtimequiz \'{$a->realtimequizname}\' in the course \'{$a->coursename}\' expired. Your answers were submitted automatically at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this realtimequiz at {$a->realtimequizurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->realtimequizname}\'';
$string['emailconfirmautosubmitsmall'] = 'Thank you for submitting your answers to \'{$a->realtimequizname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->realtimequizname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->realtimequizname}\' ({$a->realtimequizurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->realtimequizreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->realtimequizname}. See {$a->realtimequizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->realtimequizname}';
$string['emailmanualgradedbody'] = 'Hi {$a->studentname},

Your answers to \'{$a->realtimequizname}\' in course \'{$a->coursename}\' at {$a->attempttimefinish} have now been graded.

You will be able to view your score and feedback by visiting \'{$a->realtimequizurl}\' and reviewing your attempt.';

$string['emailmanualgradedsubject'] = 'Your attempt at {$a->realtimequizname} has been graded';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->realtimequizname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->realtimequizname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->realtimequizname}';
$string['empty'] = 'Empty';
...
$string['eventrealtimequizattemptabandoned'] = 'Quiz attempt abandoned';
$string['eventrealtimequizattemptregraded'] = 'Quiz attempt regraded';
$string['eventrealtimequizattemptreopened'] = 'Quiz attempt reopened';
$string['eventrealtimequizattemptstarted'] = 'Quiz attempt started';
$string['eventrealtimequizattemptsubmitted'] = 'Quiz attempt submitted';
$string['eventrealtimequizattempttimelimitexceeded'] = 'Quiz attempt time limit exceeded';
$string['eventrealtimequizgradeupdated'] = 'Quiz grade updated';
$string['eventrealtimequizrepaginated'] = 'Quiz re-paginated';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the realtimequiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the realtimequiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the realtimequiz. You have to make a trade-off based on how much you trust the performance of your server during realtimequizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final realtimequiz grade:
...
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->realtimequizgrade}.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this realtimequiz has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt realtimequizzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a realtimequiz.';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new realtimequiz, provide this many blank overall feedback boxes. Once the realtimequiz has been created, the form shows the number of fields required for the number of feedbacks in the realtimequiz. The setting must be at least 1.';
...
$string['invalidrealtimequizid'] = 'Invalid realtimequiz ID';
...
$string['legacyrealtimequizaccessrulescron'] = 'Legacy cron realtimequiz access rules';
$string['legacyrealtimequizreportscron'] = 'Legacy cron realtimequiz reports';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in realtimequiz';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->realtimequiz} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your realtimequiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own realtimequiz submissions';
$string['messageprovider:attempt_grading_complete'] = 'Notification that your attempt has been graded';
$string['messageprovider:submission'] = 'Notification of your students\' realtimequiz submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The realtimequiz activity enables a teacher to create realtimequizzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the realtimequiz to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/realtimequiz/view';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the realtimequiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the realtimequiz';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer realtimequizzes it makes sense to stretch the realtimequiz over several pages by limiting the number of questions per page. When adding questions to the realtimequiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this realtimequiz';
...
$string['nogradewarning'] = 'This realtimequiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the realtimequiz settings.';
...
$string['noquestionsinrealtimequiz'] = 'There are no questions in this realtimequiz.';
...
$string['noreview'] = 'You are not allowed to review this realtimequiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this realtimequiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This realtimequiz is currently not available to your students.';
...
$string['notifyattemptsgradedtask'] = 'Send realtimequiz attempt graded notifications';
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the realtimequiz module. As a work around, set a time limit for the whole realtimequiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this realtimequiz';
...
$string['openafterclose'] = 'Could not update the realtimequiz. You have specified an open date after the close date.';
...
$string['orderingrealtimequiz'] = 'Order and paging';
$string['orderingrealtimequizx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a realtimequiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the realtimequiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if a student fails to submit their realtimequiz attempt before the time expires. If the student is actively working on the realtimequiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/realtimequiz/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this realtimequiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->realtimequiz} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overridesforrealtimequiz'] = 'Settings overrides: {$a}';
$string['overridesnoneforgroups'] = 'No group settings overrides have been created for this realtimequiz.';
$string['overridesnoneforusers'] = 'No user settings overrides have been created for this realtimequiz.';
...
$string['overrideusereventname'] = '{$a->realtimequiz} - Override';
$string['pageshort'] = 'P';
$string['page-mod-realtimequiz-x'] = 'Any realtimequiz module page';
$string['page-mod-realtimequiz-attempt'] = 'Attempt realtimequiz page';
$string['page-mod-realtimequiz-edit'] = 'Edit realtimequiz page';
$string['page-mod-realtimequiz-report'] = 'Any realtimequiz report page';
$string['page-mod-realtimequiz-review'] = 'Review realtimequiz attempt page';
$string['page-mod-realtimequiz-summary'] = 'Quiz attempt summary page';
$string['page-mod-realtimequiz-view'] = 'Quiz information page';
...
$string['popup'] = 'Show realtimequiz in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the realtimequiz in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this realtimequiz in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewrealtimequiz'] = 'Preview {$a}';
$string['previewrealtimequizstart'] = 'Preview realtimequiz';
$string['previewrealtimequiznow'] = 'Preview realtimequiz now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The realtimequiz activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:realtimequiz'] = 'The realtimequiz activity makes use of realtimequiz reports.';
$string['privacy:metadata:realtimequiz_attempts'] = 'Details about each attempt on a realtimequiz.';
$string['privacy:metadata:realtimequiz_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:realtimequiz_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:realtimequiz_attempts:gradednotificationsenttime'] = 'The time the user was notified that manual grading of their attempt was complete';
$string['privacy:metadata:realtimequiz_attempts:preview'] = 'Whether this is a preview of the realtimequiz.';
$string['privacy:metadata:realtimequiz_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:realtimequiz_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:realtimequiz_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:realtimequiz_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:realtimequiz_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:realtimequiz_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:realtimequiz_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:realtimequiz_grades'] = 'Details about the overall grade for this realtimequiz.';
$string['privacy:metadata:realtimequiz_grades:grade'] = 'The overall grade for this realtimequiz.';
$string['privacy:metadata:realtimequiz_grades:realtimequiz'] = 'The realtimequiz that was graded.';
$string['privacy:metadata:realtimequiz_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:realtimequiz_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:realtimequiz_overrides'] = 'Details about overrides for this realtimequiz';
$string['privacy:metadata:realtimequiz_overrides:realtimequiz'] = 'The realtimequiz with override information';
$string['privacy:metadata:realtimequiz_overrides:timeclose'] = 'The new close time for the realtimequiz.';
$string['privacy:metadata:realtimequiz_overrides:timelimit'] = 'The new time limit for the realtimequiz.';
$string['privacy:metadata:realtimequiz_overrides:timeopen'] = 'The new open time for the realtimequiz.';
$string['privacy:metadata:realtimequiz_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:realtimequizaccess'] = 'The realtimequiz activity makes use of realtimequiz access rules.';
...
$string['questiondraftonly'] = 'The question {$a} is in draft status. To use it in the realtimequiz, go to the question bank and change the status to ready.';
$string['questiondraftwillnotwork'] = 'This question is in draft status. To use it in the realtimequiz, go to the question bank and change the status to ready.';
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->realtimequiznames}<br />The question will not be deleted from these realtimequizzes but only from the category list.';
...
$string['questionsinthisrealtimequiz'] = 'Questions in this realtimequiz';
...
$string['realtimequiz:addinstance'] = 'Add a new realtimequiz';
$string['realtimequiz:attempt'] = 'Attempt realtimequizzes';
$string['realtimequizavailable'] = 'The realtimequiz is available until: {$a}';
$string['realtimequizclose'] = 'Close the realtimequiz';
$string['realtimequizclosed'] = 'This realtimequiz closed on {$a}';
$string['realtimequizcloses'] = 'Quiz closes';
$string['realtimequizeventcloses'] = '{$a} closes';
$string['realtimequizcloseson'] = 'This realtimequiz will close on {$a}.';
$string['realtimequiz:deleteattempts'] = 'Delete realtimequiz attempts';
$string['realtimequiz:emailconfirmsubmission'] = 'Receive confirmation of your own realtimequiz submissions';
$string['realtimequiz:emailnotifysubmission'] = 'Receive notification of your students\' realtimequiz submissions';
$string['realtimequiz:emailnotifyattemptgraded'] = 'Receive notification when your attempt has been graded';
$string['realtimequiz:emailwarnoverdue'] = 'Receive warning when your realtimequiz attempt becomes overdue';
$string['realtimequiz:grade'] = 'Grade realtimequizzes manually';
$string['realtimequiz:ignoretimelimits'] = 'Ignore realtimequiz time limit';
$string['realtimequizisclosed'] = 'This realtimequiz is closed';
$string['realtimequizisopen'] = 'This realtimequiz is open';
$string['realtimequizisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['realtimequizisopenwillclose'] = 'Quiz open (closes {$a})';
$string['realtimequiz:manage'] = 'Manage realtimequizzes';
$string['realtimequiz:manageoverrides'] = 'Manage realtimequiz settings overrides';
$string['realtimequiz:viewoverrides'] = 'View realtimequiz settings overrides';
$string['realtimequiznavigation'] = 'Quiz navigation';
$string['realtimequizopen'] = 'Open the realtimequiz';
$string['realtimequizeventopens'] = '{$a} opens';
$string['realtimequizopenclose'] = 'Open and close dates';
$string['realtimequizopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['realtimequizopenclose_link'] = 'mod/realtimequiz/timing';
$string['realtimequizopened'] = 'This realtimequiz is open.';
$string['realtimequizopenedon'] = 'This realtimequiz opened on {$a}';
$string['realtimequizopens'] = 'Quiz opens';
$string['realtimequizopenwillclose'] = 'This realtimequiz is open, will close on {$a} at';
$string['realtimequizordernotrandom'] = 'Order of realtimequiz not shuffled';
$string['realtimequizorderrandom'] = '* Order of realtimequiz is shuffled';
$string['realtimequiz:preview'] = 'Preview realtimequizzes';
$string['realtimequiz:regrade'] = 'Regrade realtimequiz attempts';
$string['realtimequiz:reopenattempts'] = 'Reopen never submitted realtimequiz attempts';
$string['realtimequizreport'] = 'Quiz report';
$string['realtimequiz:reviewmyattempts'] = 'Review your own attempts';
$string['realtimequizsettings'] = 'Realtimequiz settings';
$string['realtimequiz:view'] = 'View realtimequiz information';
$string['realtimequiz:viewreports'] = 'View realtimequiz reports';
$string['realtimequiztimer'] = 'Quiz Timer';
$string['realtimequizwillopen'] = 'This realtimequiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole realtimequiz to be graded.  Are you sure you want to continue?';
$string['reattemptrealtimequiz'] = 'Re-attempt realtimequiz';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this realtimequiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingrealtimequiz'] = 'Regrading realtimequiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallrealtimequizattempts'] = 'Delete all realtimequiz attempts';
...
$string['reopenedattemptwillbeinprogressuntil'] = 'The attempt will remain open and can be continued until the realtimequiz closes on {$a}.';
...
$string['reportusersall'] = 'all users who have attempted the realtimequiz';
$string['reportuserswith'] = 'enrolled users who have attempted the realtimequiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the realtimequiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the realtimequiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the realtimequiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Quiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) realtimequiz, to ensure that only people in a certain location can access the realtimequiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to realtimequiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after realtimequiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while realtimequiz is open';
$string['reviewclosed'] = 'After the realtimequiz is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->realtimequiz} by {$a->user}';
$string['reviewopen'] = 'Later, while the realtimequiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a realtimequiz attempt or look at the realtimequiz reports.
...
**Later, while the realtimequiz is still open** settings apply after this, and before the realtimequiz close date.

**After the realtimequiz is closed** settings apply after the realtimequiz close date has passed. If the realtimequiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current realtimequiz attempt.';
...
$string['saverealtimequiz'] = 'Save this whole realtimequiz';
...
$string['showblocks'] = 'Show blocks during realtimequiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during realtimequiz attempts';
...
$string['shufflequestions_help'] = 'If enabled, every time the realtimequiz is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the realtimequiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonrealtimequiz'] = 'Specified question is not on the specified realtimequiz';
...
$string['subneterror'] = 'Sorry, this realtimequiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this realtimequiz.';
$string['subnetnotice'] = 'This realtimequiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_realtimequiz'] = 'Report';
$string['subplugintype_realtimequiz_plural'] = 'Reports';
$string['subplugintype_realtimequizaccess'] = 'Access rule';
$string['subplugintype_realtimequizaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the realtimequiz.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the realtimequiz since you have not passed the time delay before attempting another realtimequiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial realtimequiz page and a countdown timer is displayed in the realtimequiz navigation block.';
$string['timelimit_link'] = 'mod/realtimequiz/timing';
...
$string['updateoverdueattemptstask'] = 'Updating overdue realtimequiz attempts';
$string['updatesettings'] = 'Update realtimequiz settings';
$string['updaterealtimequizslotswithrandomxofy'] = 'Updating realtimequiz slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the realtimequiz module will perform an extensive change of the realtimequiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingrealtimequizattempts'] = 'Upgrading realtimequiz attempts: realtimequiz {$a->done}/{$a->outof} (Quiz id {$a->info})';
$string['upgradingveryoldrealtimequizattempts'] = 'Upgrading very old realtimequiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this realtimequiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} realtimequiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this realtimequiz';
$string['yourfinalgradeis'] = 'Your final grade for this realtimequiz is {$a}.';
$string['questionversion'] = 'v{$a}';
$string['questionversionlatest'] = 'v{$a} (latest)';
$string['alwayslatest'] = 'Always latest';
$string['gobacktorealtimequiz'] = 'Go back';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the realtimequiz settings) or higher.';
$string['completiondetail:passgrade'] = 'Receive a pass grade';
$string['gradetopassnotset'] = 'This realtimequiz does not yet have a grade to pass set. It may be set in the Grade section of the realtimequiz settings.';
$string['basicideasofrealtimequiz'] = 'The basic ideas of realtimequiz-making';
