...
/**
 * A form that limits student's access to attempt a realtimequiz.
 *
...
class preflight_check_form extends moodleform {
    ...
    protected function definition() {
        $mform = $this->_form;
        $this->_form->updateAttributes(['id' => 'mod_realtimequiz_preflight_form']);
        ...
        $this->add_action_buttons(true, get_string('startattempt', 'realtimequiz'));
    ...
    public function validation($data, $files): array {
        ...
        $accessmanager = $this->_customdata['realtimequizobj']->get_access_manager(time());
