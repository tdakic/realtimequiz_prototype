...
/**
 * The mod_realtimequiz attempt summary viewed event.
 *
...
/**
 * The mod_realtimequiz attempt summary viewed event class.
 *
...
class attempt_summary_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptsummaryviewed', 'mod_realtimequiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the summary for the attempt with id '$this->objectid' belonging " .
            "to the user with id '$this->relateduserid' for the realtimequiz with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/realtimequiz/summary.php', ['attempt' => $this->objectid]);
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['realtimequizid'])) {
            throw new \coding_exception('The \'realtimequizid\' must be set in other.');
        }
    }
