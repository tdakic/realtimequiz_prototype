...
/**
 * The mod_realtimequiz attempt viewed event.
 *
...
/**
 * The mod_realtimequiz attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_realtimequiz');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' has viewed page '$page' of the attempt with id " .
            "'$this->objectid' belonging to the user with id '$this->relateduserid' for the realtimequiz " .
