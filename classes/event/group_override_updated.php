...
/**
 * The mod_realtimequiz group override updated event.
 *
...
/**
 * The mod_realtimequiz group override updated event class.
 *
...
class group_override_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverrideupdated', 'mod_realtimequiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the override with id '$this->objectid' for the realtimequiz with " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/realtimequiz/overrideedit.php', ['id' => $this->objectid]);
    }
