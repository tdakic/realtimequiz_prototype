...
/**
 * The mod_realtimequiz slots deleted event.
 *
...
/**
 * The mod_realtimequiz slot deleted event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int realtimequizid: the id of the realtimequiz.
 *      - int slotnumber: the slot number in realtimequiz.
 * }
 *
 * @package    mod_realtimequiz
 * @copyright  2021 The Open University
...
class slot_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventslotdeleted', 'mod_realtimequiz');
    }

    public function get_description() {
        return "The user with id '$this->userid' deleted the slot with id '{$this->objectid}' " .
            "and slot number '{$this->other['slotnumber']}' " .
            "from the realtimequiz with course module id '$this->contextinstanceid'.";
    }
