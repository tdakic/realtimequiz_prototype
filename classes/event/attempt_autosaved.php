...
/**
 * The mod_realtimequiz attempt auto-saved event.
 *
...
/**
 * The mod_realtimequiz attempt auto-saved event class.
 *
...
class attempt_autosaved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptautosaved', 'mod_realtimequiz');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' is working on page " .
            ...
            "with id '$this->objectid' for the realtimequiz with course module id '$this->contextinstanceid', " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/realtimequiz/review.php', [
