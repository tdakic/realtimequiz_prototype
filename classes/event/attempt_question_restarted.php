...
/**
 * The mod_realtimequiz attempt question restarted event.
 *
...
/**
 * The mod_realtimequiz attempt question restarted event class.
 *
...
class attempt_question_restarted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptquestionrestarted', 'mod_realtimequiz');
    }
