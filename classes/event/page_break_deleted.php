...
/**
 * The mod_realtimequiz page break deleted event.
 *
...
/**
 * The mod_realtimequiz page break deleted event class.
 *
...
class page_break_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpagebreakdeleted', 'mod_realtimequiz');
    }
