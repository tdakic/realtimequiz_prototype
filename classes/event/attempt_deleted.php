...
/**
 * The mod_realtimequiz attempt deleted event.
 *
...
/**
 * The mod_realtimequiz attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_realtimequiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the realtimequiz " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/realtimequiz/report.php', ['id' => $this->contextinstanceid]);
    }
