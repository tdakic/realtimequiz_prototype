...
/**
 * The mod_realtimequiz attempt preview started event.
 *
...
/**
 * The mod_realtimequiz attempt preview started event class.
 *
...
class attempt_preview_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptpreviewstarted', 'mod_realtimequiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' previewed by " .
            "the user with id '$this->userid' for the realtimequiz with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/realtimequiz/view.php', ['id' => $this->contextinstanceid]);
    }
