 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
trait legacy_realtimequizaccess_polyfill {
    ...
    public static function export_realtimequizaccess_user_data(\mod_realtimequiz\realtimequiz_settings $realtimequiz, \stdClass $user) : \stdClass {
        return static::_export_realtimequizaccess_user_data($realtimequiz, $user);
    }
    ...
    public static function delete_realtimequizaccess_data_for_all_users_in_context(\mod_realtimequiz\realtimequiz_settings $realtimequiz) {
        static::_delete_realtimequizaccess_data_for_all_users_in_context($realtimequiz);
    }
    ...
    public static function delete_realtimequizaccess_data_for_user(\mod_realtimequiz\realtimequiz_settings $realtimequiz, \stdClass $user) {
        static::_delete_realtimequizaccess_data_for_user($realtimequiz, $user);
    }
    ...
    public static function delete_realtimequizaccess_data_for_users(approved_userlist $userlist) {
        static::_delete_realtimequizaccess_data_for_users($userlist);
    }
}
