...
/**
 * This class captures all the various information to render the front page of the realtimequiz activity.
 *
 ...
 */
class view_page {
    /** @var array $infomessages of messages with information to display about the realtimequiz. */
    public $infomessages;
    /** @var array $attempts contains all the user's attempts at this realtimequiz. */
    public $attempts;
    /** @var realtimequiz_attempt[] $attemptobjs objects corresponding to $attempts. */
    public $attemptobjs;
    ...
    /** @var bool $canedit whether the current user has the capability to edit the realtimequiz. */
    public $canedit;
    /** @var moodle_url $editurl the URL for editing this realtimequiz. */
    public $editurl;
    ...
    public $numattempts;
    /** @var float $mygrade contains the user's final grade for a realtimequiz. */
    public $mygrade;
    ...
    public $popupoptions;
    /** @var bool $realtimequizhasquestions whether the realtimequiz has any questions. */
    public $realtimequizhasquestions;
}
