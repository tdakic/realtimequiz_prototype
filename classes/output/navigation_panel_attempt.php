...
/**
 * Specialisation of {@see navigation_panel_base} for the attempt realtimequiz page.
 *
...
class navigation_panel_attempt extends navigation_panel_base {
    ...
    public function render_before_button_bits(renderer $output) {
        return html_writer::tag('div', get_string('navnojswarning', 'realtimequiz'),
                ['id' => 'realtimequiznojswarning']);
    }
    ...
    public function render_end_bits(renderer $output) {
        ...
        return html_writer::link($this->attemptobj->summary_url(),
                get_string('endtest', 'realtimequiz'), ['class' => 'endtestlink aalink']) .
