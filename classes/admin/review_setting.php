...
namespace mod_realtimequiz\admin;

/**
 * Admin settings class for the realtimequiz review options.
 *
...
class review_setting extends \admin_setting {
    ...
    /**
     * This should match {@link mod_realtimequiz_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return [
            'attempt'          => get_string('theattempt', 'realtimequiz'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'realtimequiz'),
        ];
    }
    ...
    protected static function times() {
        return [
            self::DURING            => get_string('reviewduring', 'realtimequiz'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'realtimequiz'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'realtimequiz'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'realtimequiz'),
        ];
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'realtimequiz'), $query);
    }
}
