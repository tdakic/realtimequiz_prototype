...
/**
 * A {@see qubaid_condition} representing all the attempts by one user at a given realtimequiz.
 *
...
class qubaids_for_users_attempts extends \qubaid_join {
     ...
     * Constructor.
     *
     * This takes the same arguments as {@link realtimequiz_get_user_attempts()}.
     *
     ...
     */
    public function __construct($realtimequizid, $userid, $status = 'finished', $includepreviews = false) {
        $where = 'realtimequiza.realtimequiz = :realtimequizarealtimequiz AND realtimequiza.userid = :userid';
        $params = ['realtimequizarealtimequiz' => $realtimequizid, 'userid' => $userid];
