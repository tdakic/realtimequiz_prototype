...
namespace mod_realtimequiz\question\bank\filter;

use core_question\local\bank\question_version_status;

/**
 * A custom filter condition helper for realtimequiz to select question categories.
 *
 * This is required as realtimequiz will only use ready questions and the count should show according to that.
 *
