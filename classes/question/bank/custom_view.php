...
/**
 * Defines the custom question bank view used on the Edit realtimequiz page.
 *
...
class custom_view extends \core_question\local\bank\view {
     ...
     */
    public function __construct($contexts, $pageurl, $course, $cm, $realtimequiz) {
    ...
    protected function get_question_bank_plugins(): array {
        ...
        foreach ($corequestionbankcolumns as $fullname) {
            $shortname = $fullname;
            if (class_exists('mod_realtimequiz\\question\\bank\\' . $fullname)) {
                $fullname = 'mod_realtimequiz\\question\\bank\\' . $fullname;
    ...
    protected function default_sort(): array {
        ...
        return [
            ...
            'mod_realtimequiz\\question\\bank\\question_name_text_column' => 1,
        ];
    }
     ...
     */
    public function set_realtimequiz_has_attempts($realtimequizhasattempts): void {
    ...
    public function preview_question_url($question) {
        return realtimequiz_question_preview_url($this->realtimequiz, $question);
    }
