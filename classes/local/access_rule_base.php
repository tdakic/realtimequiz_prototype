...
namespace mod_realtimequiz\local;
...
/**
 * Base class for rules that restrict the ability to attempt a realtimequiz.
 *
...
abstract class access_rule_base {
    ...
    /** @var realtimequiz_settings the realtimequiz object. */
     ...
     */
    public function __construct($realtimequizobj, $timenow) {
        $this->realtimequizobj = $realtimequizobj;
        $this->realtimequiz = $realtimequizobj->get_realtimequiz();
     ...
     *
     * @param preflight_check_form $realtimequizform the form being built.
    ...
    /**
     * This is called when the current attempt at the realtimequiz is finished. This is
     ...
     *
     * This information is show shown, for example, on the realtimequiz view page, to explain this
     ...
     * this realtimequiz, for example because the last possible start time is past, or all attempts
     ...
     * method is called from {@see mod_realtimequiz_mod_form::definition()}, while the
    ...
    /**
     * Get any options this rule adds to the 'Browser security' realtimequiz setting.
     *
     ...
     * is called from {@see realtimequiz_after_add_or_update()} in lib.php.
     ...
     * from {@see realtimequiz_delete_instance()} in lib.php.
     ...
     */
    public static function get_settings_sql($realtimequizid) {
        return ['', '', []];
    }
     ...
     */
    public static function get_extra_settings($realtimequizid) {
        return [];
    }
}
