...
/**
 * Capability definitions for the realtimequiz manual grading report.
 *
...
$capabilities = [
    ...
    'realtimequiz/grading:viewstudentnames' => [
        'captype' => 'read',
        ...
        'clonepermissionsfrom' => 'mod/realtimequiz:viewreports'
    ],
    ...
    'realtimequiz/grading:viewidnumber' => [
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'legacy' => [
            'teacher' => CAP_ALLOW,
