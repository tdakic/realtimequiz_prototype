@mod @mod_realtimequiz @realtimequiz @realtimequiz_grading
Feature: Basic use of the Manual grading report
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz     | Quiz 1 | C1     | realtimequiz1    | 1         | tging    |
      | realtimequiz     | Quiz 2 | C1     | realtimequiz2    | 1         | tging    |
    And realtimequiz "Quiz 1" contains the following questions:
      | question         | page |
      | Short answer 001 | 1    |

  Scenario: Manual grading report without attempts
    When I am on the "Quiz 1" "mod_realtimequiz > Manual grading report" page logged in as "teacher1"
  ...
  Scenario: Manual grading settings are remembered as user preferences
    ...
    And I press "Change options"
    And I log out
    And I am on the "Quiz 1" "mod_realtimequiz > Manual grading report" page logged in as "teacher1"
    And I follow "Also show questions that have been graded automatically"
    And I click on "update grades" "link" in the "Short answer 001" "table_row"
  ...
  Scenario: A marker cannot access the report in separate group
    ...
    And user "student2" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | Duck     |
    When I am on the "Quiz 1" "mod_realtimequiz > Manual grading report" page logged in as "marker"
  ...
  Scenario: Manual grading report with attempts to be graded
    ...
    And realtimequiz "Quiz 2" contains the following questions:
      ...
      | Essay Q1 | 1    |
    And I log out
    When I am on the "Quiz 2" "mod_realtimequiz > View" page logged in as "student1"
    ...
    And I am on the "Quiz 2" "mod_realtimequiz > Manual grading report" page logged in as "teacher1"
    And I follow "Also show questions that have been graded automatically"
