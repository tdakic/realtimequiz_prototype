@mod @mod_realtimequiz @realtimequiz @realtimequiz_statistics
Feature: Basic use of the Statistics report
  ...
  Scenario: Report works when there are no attempts
    When I am on the "Quiz 1" "mod_realtimequiz > Statistics report" page logged in as teacher1
    Then I should see "No attempts have been made at this realtimequiz, or all attempts have questions that need manual grading."
    ...
    And user "student3" has attempted "Quiz 1" with responses:
      ...
      |   2  | False    |
      |   3  | False    |
    And I am on the "Quiz 1" "mod_realtimequiz > Statistics report" page logged in as teacher1
