...
use realtimequiz_statistics_table;
...
/**
 * Class realtimequiz_statistics_statistics_table_testcase
 *
...
class statistics_table_test extends \advanced_testcase {
    ...
    public function test_format_percentage() {
        $table = new realtimequiz_statistics_table();

        // The format_percentage method is protected. Use Reflection to call the method.
        $reflector = new \ReflectionClass('realtimequiz_statistics_table');
