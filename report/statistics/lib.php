...
/**
 * Standard plugin entry points of the realtimequiz statistics report.
 *
 ...
 * @package  realtimequiz_statistics
 * @category files
 * @param context $previewcontext the realtimequiz context
 ...
 */
function realtimequiz_statistics_question_preview_pluginfile($previewcontext, $questionid,
    ...
    require_capability('realtimequiz/statistics:view', $context);
