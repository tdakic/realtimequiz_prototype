...
/**
 * Class to store the options for a {@link realtimequiz_overview_report}.
 *
 * @copyright 2012 The Open University
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class realtimequiz_overview_options extends attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('realtimequiz_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (realtimequiz_has_grades($this->realtimequiz)) {
            set_user_preference('realtimequiz_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                ['mod/realtimequiz:regrade', 'mod/realtimequiz:deleteattempts'], context_module::instance($this->cm->id))
