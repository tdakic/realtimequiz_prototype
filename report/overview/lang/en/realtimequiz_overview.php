...
/**
 * Strings for component 'realtimequiz_overview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this realtimequiz.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this realtimequiz.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the realtimequiz';
$string['optattemptsonly'] = '{$a} who have attempted the realtimequiz';
$string['optnoattemptsonly'] = '{$a} who have not attempted the realtimequiz';
...
$string['privacy:metadata:preference:realtimequiz_overview_slotmarks'] = 'Whether to show marks for each question slot.';
...
$string['showinggradedandungraded'] = 'Showing graded and ungraded attempts for each user. The one attempt for each user that is graded is highlighted. The grading method for this realtimequiz is {$a}.';
