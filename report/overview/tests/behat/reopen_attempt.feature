...
Feature: Reopening Never submitted realtimequiz attempts
    In order to cut some slack to students who forgot to submit their realtimequiz attempt
    As a teacher
  ...
  Background:
    ...
    And realtimequiz "Test realtimequiz" contains the following questions:
      | question | page |
      | TF       | 1    |
    And user "student" has started an attempt at realtimequiz "Test realtimequiz"
    And the attempt at "Test realtimequiz" by "student" was never submitted

  Scenario: Attempt can be reopened
    Given I am on the "Test realtimequiz" "mod_realtimequiz > Grades report" page logged in as teacher
    When I press "Reopen"
