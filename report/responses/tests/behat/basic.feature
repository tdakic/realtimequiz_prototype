@mod @mod_realtimequiz @realtimequiz @realtimequiz_reponses
Feature: Basic use of the Responses report
  In order to see how my students are progressing
  As a teacher
  I need to see all their realtimequiz responses
  ...
  Background: Using the Responses report
    ...
    And the following "activities" exist:
      ...
      | realtimequiz       | Quiz 1 | Quiz 1 description | C1     | realtimequiz1    | interactive        |
  ...
  Scenario: Report works when there are no attempts
    When I am on the "Quiz 1" "mod_realtimequiz > Responses report" page logged in as teacher
    Then I should see "Attempts: 0"
    And I should see "Nothing to display"
    And I set the field "Attempts from" to "enrolled users who have not attempted the realtimequiz"

  @javascript
  Scenario: Report works when there are attempts
    Given user "student1" has started an attempt at realtimequiz "Quiz 1"
    And user "student1" has checked answers in their attempt at realtimequiz "Quiz 1":
      | slot | response |
      |   1  | 1.0      |
    And user "student1" has checked answers in their attempt at realtimequiz "Quiz 1":
      | slot | response |
    ...
    And user "student1" has checked answers in their attempt at realtimequiz "Quiz 1":
      | slot | response |
      |   1  | 3.14     |
    And user "student1" has finished an attempt at realtimequiz "Quiz 1"

    When I am on the "Quiz 1" "mod_realtimequiz > Responses report" page logged in as teacher
    Then I should see "Attempts: 1"
    And I should see "Student One"
    And I should not see "Student Two"
    And I set the field "Attempts from" to "enrolled users who have, or have not, attempted the realtimequiz"
  ...
  Scenario: Report does not allow strange combinations of options
    Given I am on the "Quiz 1" "mod_realtimequiz > Responses report" page logged in as teacher
    And the "Which tries" "select" should be enabled
    When I set the field "Attempts from" to "enrolled users who have not attempted the realtimequiz"
