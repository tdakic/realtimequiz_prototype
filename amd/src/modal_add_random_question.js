 ...
 *
 * @module     mod_realtimequiz/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_realtimequiz-realtimequiz-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_realtimequiz/modal_add_random_question'
        );
