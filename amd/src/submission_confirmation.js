...
/**
 * A javascript module to handle submission confirmation for realtimequiz.
 *
 * @module    mod_realtimequiz/submission_confirmation
...
const SELECTOR = {
    attemptSubmitButton: '.path-mod-realtimequiz .btn-finishattempt button',
    attemptSubmitForm: 'form#frm-finishattempt',
};

const TEMPLATES = {
    submissionConfirmation: 'mod_realtimequiz/submission_confirmation',
};
...
export const init = (unAnsweredQuestions) => {
    ...
    Prefetch.prefetchStrings('realtimequiz', ['submitallandfinish', 'submission_confirmation']);
