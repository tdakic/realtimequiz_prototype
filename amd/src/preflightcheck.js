 ...
 *
 * This is also responsible for opening the pop-up window, if the realtimequiz requires to be in one.
 *
 * @module    mod_realtimequiz/preflightcheck
...
define(['jquery', 'core/yui', 'core_form/changechecker'], function($, Y, FormChangeChecker) {
    ...
    /**
     * @alias module:mod_realtimequiz/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the realtimequiz should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_realtimequiz_preflight_popup']
                    });
        ...
        /**
         * Event handler for the realtimequiz start attempt button.
