 ...
 * &lt;button type="button" data-action="reopen-attempt" data-attempt-id="227000" data-after-action-url="/mod/realtimequiz/report.php">
 ...
 *
 * @module    mod_realtimequiz/reopen_attempt_ui
...
const reopenButtonClicked = async(e) => {
    ...
    try {
        ...
        const messages = fetchMany([{
            methodname: 'mod_realtimequiz_get_reopen_attempt_confirmation',
            args: {
                "attemptid": attemptId,
            },
        }]);
        ...
        await saveCancelPromise(
            getString('reopenattemptareyousuretitle', 'mod_realtimequiz'),
            messages[0],
            getString('reopenattempt', 'mod_realtimequiz'),
            {triggerElement: e.target},
       );

        await (fetchMany([{
            methodname: 'mod_realtimequiz_reopen_attempt',
            args: {
                "attemptid": attemptId,
            },
        }])[0]);
