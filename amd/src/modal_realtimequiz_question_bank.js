 ...
 *
 * @module     mod_realtimequiz/modal_realtimequiz_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_QUIZ_CONTAINER: 'td.addtorealtimequizaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_realtimequiz-realtimequiz-question-bank';
     ...
     * when the user clicks the add to realtimequiz link.
     *
     ...
     *      - The realtimequiz category select box
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('submit', SELECTORS.ADD_QUESTIONS_FORM, function(e) {
            // If the user clicks on the "Add selected questions to the realtimequiz" button to add some questions to the page
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to realtimequiz link.
