YUI.add('moodle-mod_realtimequiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_realtimequiz-questionchooser'
});

M.mod_realtimequiz = M.mod_realtimequiz || {};
M.mod_realtimequiz.init_questionchooser = function() {
    M.mod_realtimequiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_realtimequiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_realtimequiz-util", "querystring-parse"]});
