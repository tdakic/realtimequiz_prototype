YUI.add('moodle-mod_realtimequiz-realtimequizbase', function (Y, NAME) {

/**
 * The realtimequizbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_realtimequiz-realtimequizbase
 */
var QUIZBASENAME = 'mod_realtimequiz-realtimequizbase';
...
M.mod_realtimequiz.realtimequizbase = M.mod_realtimequiz.realtimequizbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_realtimequiz.edit = M.mod_realtimequiz.edit || {};
 ...
 */
M.mod_realtimequiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_realtimequiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
