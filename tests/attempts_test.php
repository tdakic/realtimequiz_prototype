...
use mod_realtimequiz_generator;
use question_engine;
...
/**
 * Unit tests for realtimequiz attempt overdue handling
 *
...
class attempts_test extends \advanced_testcase {
    ...
    /**
     * Test the functions realtimequiz_update_open_attempts(), get_list_of_overdue_attempts() and
    ...
    public function test_bulk_update_functions() {
        ...
        // Basic realtimequiz settings

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        $usertimes[$attemptid] = ['timeclose' => 1200, 'timelimit' => 600, 'message' => 'Test1A', 'time1000state' => 'finished'];

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 1800]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        $usertimes[$attemptid] = ['timeclose' => 1200, 'timelimit' => 1800, 'message' => 'Test1B', 'time1000state' => 'inprogress'];

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        $usertimes[$attemptid] = ['timeclose' => 1200, 'timelimit' => 0, 'message' => 'Test1C', 'time1000state' => 'inprogress'];

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 600]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        $usertimes[$attemptid] = ['timeclose' => 0, 'timelimit' => 600, 'message' => 'Test1D', 'time1000state' => 'finished'];

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => null]);
        $usertimes[$attemptid] = ['timeclose' => 1300, 'timelimit' => 0, 'message' => 'Test2A', 'time1000state' => 'inprogress'];

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 0]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1100, 'timelimit' => null]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => null, 'timelimit' => 700]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => null, 'timelimit' => 500]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 0, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => null, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        $usertimes[$attemptid] = ['timeclose' => 1300, 'timelimit' => 500, 'message' => 'Test2F', 'time1000state' => 'finished'];
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 1000, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz), 'attempt' => 1]);
        $usertimes[$attemptid] = ['timeclose' => 1300, 'timelimit' => 500, 'message' => 'Test2G', 'time1000state' => 'inprogress'];

        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group3->id, 'timeclose' => 1300, 'timelimit' => 500]); // User not in group.
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 501]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 1301, 'timelimit' => 500]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1301, 'timelimit' => 500]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 1300, 'timelimit' => 501]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 1300, 'timelimit' => 501]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group3->id, 'timeclose' => 1500, 'timelimit' => 1000]); // User not in group.
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => null, 'timelimit' => 501]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 1301, 'timelimit' => null]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 1301, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 500]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 0, 'timelimit' => 501]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'timeclose' => 1200, 'timelimit' => 600]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'timeclose' => 1201, 'timelimit' => 601]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'timeclose' => 0, 'timelimit' => 601]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'timeclose' => 1201, 'timelimit' => 0]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'timeclose' => null, 'timelimit' => 601]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'timeclose' => 1201, 'timelimit' => null]);
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group1->id, 'timeclose' => 1300, 'timelimit' => 700]);
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'userid' => 0, 'timeclose' => 1201, 'timelimit' => 601]); // Not user.
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'inprogress',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        $attemptid = $DB->insert_record('realtimequiz_attempts', ['realtimequiz' => $realtimequiz->id, 'userid' => $user1->id, 'state' => 'overdue',
                'timestart' => 100, 'timecheckstate' => 0, 'layout' => '', 'uniqueid' => $this->usage_id($realtimequiz)]);
        ...
        foreach ($usertimes as $attemptid => $times) {
            $attempt = $DB->get_record('realtimequiz_attempts', ['id' => $attemptid], '*', MUST_EXIST);
        ...
        //
        // Test realtimequiz_update_open_attempts().
        //

        realtimequiz_update_open_attempts(['courseid' => $course->id]);
        foreach ($usertimes as $attemptid => $times) {
            $attempt = $DB->get_record('realtimequiz_attempts', ['id' => $attemptid], '*', MUST_EXIST);

            if ($attempt->state == 'overdue') {
                $graceperiod = $DB->get_field('realtimequiz', 'graceperiod', ['id' => $attempt->realtimequiz]);
            } else {
                $graceperiod = 0;
            }
        ...
        $attempts->close();
        $this->assertEquals($DB->count_records_select('realtimequiz_attempts', 'timecheckstate IS NOT NULL'), $count);
        ...
        [$count, $realtimequizcount] = $overduehander->update_all_overdue_attempts(1000, 940);

        $attempts = $DB->get_records('realtimequiz_attempts', null, 'realtimequiz, userid, attempt',
                'id, realtimequiz, userid, attempt, state, timestart, timefinish, timecheckstate');
        foreach ($attempts as $attempt) {
            $this->assertTrue(isset($usertimes[$attempt->id]));
            $times = $usertimes[$attempt->id];
        ...
        $this->assertEquals(19, $realtimequizcount);
    }

    /**
     * Make any old question usage for a realtimequiz.
     *
     ...
     */
    protected function usage_id(\stdClass $realtimequiz): int {
        $quba = question_engine::make_questions_usage_by_activity('mod_realtimequiz',
                \context_module::instance($realtimequiz->cmid));
    ...
    public function test_group_event_handlers() {
        ...
        $this->assertEquals(1300, $DB->get_field('realtimequiz_attempts', 'timecheckstate', ['id' => $attemptid]));

        // remove from group
        $this->assertTrue(groups_remove_member($group1, $user1));
        $this->assertEquals(1200, $DB->get_field('realtimequiz_attempts', 'timecheckstate', ['id' => $attemptid]));
        ...
        $this->assertEquals(1200, $DB->get_field('realtimequiz_attempts', 'timecheckstate', ['id' => $attemptid]));
        $this->assertEquals(0, $DB->count_records('realtimequiz_overrides', ['realtimequiz' => $realtimequiz->id]));

        // add a group2 override
        $DB->insert_record('realtimequiz_overrides',
                ['realtimequiz' => $realtimequiz->id, 'groupid' => $group2->id, 'timeclose' => 1400, 'timelimit' => null]);
        realtimequiz_update_open_attempts(['realtimequizid' => $realtimequiz->id]);
        $this->assertEquals(1400, $DB->get_field('realtimequiz_attempts', 'timecheckstate', ['id' => $attemptid]));
    ...
    /**
     * Test the functions realtimequiz_create_attempt_handling_errors
     */
    public function test_realtimequiz_create_attempt_handling_errors() {
        ...
        $realtimequiz = $realtimequizgenerator->create_instance(['course' => $course->id, 'questionsperpage' => 0, 'grade' => 100.0,
            'sumgrades' => 2]);
        // Create questions.
        ...
        $timenow = time();
        // Create an attempt.
        $attempt = realtimequiz_create_attempt($realtimequizobj, 1, null, $timenow, false, $user1->id);
        ...
        $result = realtimequiz_create_attempt_handling_errors($attempt->id, $realtimequiz->cmid);
        $this->assertEquals($result->get_attemptid(), $attempt->id);
        try {
            $result = realtimequiz_create_attempt_handling_errors($attempt->id, 9999);
            $this->fail('Exception expected due to invalid course module id.');
        } catch (\moodle_exception $e) {
            $this->assertEquals('invalidcoursemodule', $e->errorcode);
        }
        try {
            realtimequiz_create_attempt_handling_errors(9999, $result->get_cmid());
            $this->fail('Exception expected due to realtimequiz content change.');
        } catch (\moodle_exception $e) {
            $this->assertEquals('attempterrorcontentchange', $e->errorcode);
        }
        try {
            realtimequiz_create_attempt_handling_errors(9999);
            $this->fail('Exception expected due to invalid realtimequiz attempt id.');
        } catch (\moodle_exception $e) {
        ...
        try {
            realtimequiz_create_attempt_handling_errors(9999, $result->get_cmid());
            $this->fail('Exception expected due to realtimequiz content change for user without permission.');
        } catch (\moodle_exception $e) {
            $this->assertEquals('attempterrorcontentchangeforuser', $e->errorcode);
        }
        try {
            realtimequiz_create_attempt_handling_errors($attempt->id, 9999);
