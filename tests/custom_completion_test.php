...
use grade_item;
use mod_realtimequiz\completion\custom_completion;
use question_engine;
...
/**
 * Class for unit testing mod_realtimequiz/custom_completion.
 *
 * @package   mod_realtimequiz
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @coversDefaultClass \mod_realtimequiz\completion\custom_completion
 */
class custom_completion_test extends advanced_testcase {
     ...
     * @return array [$students, $realtimequiz, $cm, $litecm]
     */
    private function setup_realtimequiz_for_testing_completion(array $completionoptions): array {
        global $CFG, $DB;
        ...
        $litecm = get_coursemodule_from_id('realtimequiz', $realtimequiz->cmid);
     ...
     *
     * @param array $attemptoptions ['realtimequiz'] => object, ['student'] => object, ['tosubmit'] => array, ['attemptnumber'] => int
     */
    private function do_attempt_realtimequiz(array $attemptoptions) {
        $realtimequizobj = realtimequiz_settings::create((int) $attemptoptions['realtimequiz']->id);
    ...
    /**
     * Test checking the completion state of a realtimequiz base on core's completionpassgrade criteria.
     * The realtimequiz requires a passing grade to be completed.
     */
    public function test_completionpass() {
        list($students, $realtimequiz, $cm) = $this->setup_realtimequiz_for_testing_completion([
            'nbstudents' => 2,
            'qtype' => 'numerical',
            'realtimequizoptions' => [
    ...
    public function test_update_moduleinfo() {
        ...
        list($students, $realtimequiz, $cm, $litecm) = $this->setup_realtimequiz_for_testing_completion([
            'nbstudents' => 1,
            'qtype' => 'numerical',
            'nbquestions' => 2,
            'sumgrades' => 100,
        ...
        // Update realtimequiz with passgrade = 20 and use highest grade to calculate.
        $moduleinfo = $this->prepare_module_info($cm, $realtimequiz, $course, 20, QUIZ_GRADEHIGHEST);
        ...
        // Update realtimequiz with gradepass = 80 and use highest grade to calculate completion.
        $moduleinfo = $this->prepare_module_info($cm, $realtimequiz, $course, 80, QUIZ_GRADEHIGHEST);
        update_moduleinfo($litecm, $moduleinfo, $course, null);
        ...
        // Update realtimequiz with gradepass = 80 and use average grade to calculate completion.
        $moduleinfo = $this->prepare_module_info($cm, $realtimequiz, $course, 80, QUIZ_GRADEAVERAGE);
        update_moduleinfo($litecm, $moduleinfo, $course, null);
        ...
        // Update realtimequiz with gradepass = 50 and use average grade to calculate completion.
        $moduleinfo = $this->prepare_module_info($cm, $realtimequiz, $course, 50, QUIZ_GRADEAVERAGE);
        update_moduleinfo($litecm, $moduleinfo, $course, null);
        ...
        // Update realtimequiz with gradepass = 50 and use first attempt grade to calculate completion.
        $moduleinfo = $this->prepare_module_info($cm, $realtimequiz, $course, 50, QUIZ_ATTEMPTFIRST);
        update_moduleinfo($litecm, $moduleinfo, $course, null);
        ...
        // Update realtimequiz with gradepass = 50 and use last attempt grade to calculate completion.
        $moduleinfo = $this->prepare_module_info($cm, $realtimequiz, $course, 50, QUIZ_ATTEMPTLAST);
        update_moduleinfo($litecm, $moduleinfo, $course, null);
    ...
    /**
     * Set up moduleinfo object sample data for realtimequiz instance.
     *
     * @param cm_info $cm course-module instance
     * @param stdClass $realtimequiz realtimequiz instance data.
     ...
     * @return stdClass
     */
    private function prepare_module_info(cm_info $cm, stdClass $realtimequiz, stdClass $course,
        ...
        $moduleinfo->modulename = 'realtimequiz';
        $moduleinfo->realtimequizpassword = '';
        ...
        $moduleinfo->name = $realtimequiz->name;
        $moduleinfo->timeopen = $realtimequiz->timeopen;
        $moduleinfo->timeclose = $realtimequiz->timeclose;
        $moduleinfo->timelimit = $realtimequiz->timelimit;
        $moduleinfo->graceperiod = $realtimequiz->graceperiod;
        $moduleinfo->decimalpoints = $realtimequiz->decimalpoints;
        $moduleinfo->questiondecimalpoints = $realtimequiz->questiondecimalpoints;
