...
Feature: Settings form fields disabled if not required
  In to create realtimequizzes as simply as possible
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz     | C1     | 1       | Test realtimequiz 1 |

  @javascript
  Scenario: Depending on the number of attempts, different form fields are disabled.
    When I am on the "Test realtimequiz 1" "realtimequiz activity editing" page logged in as teacher
  ...
  Scenario: Depending on whether there is a close date, some review options are disabled.
    ...
    And I expand all fieldsets
    And I set the field "Name" to "Test realtimequiz"
  ...
  @javascript
  Scenario: If there are realtimequiz attempts, there is not option to repaginate.
    ...
    And realtimequiz "Quiz 1" contains the following questions:
      ...
      | TF1      | 1    |         |
    When I am on the "Quiz 1" "realtimequiz activity editing" page logged in as teacher
    And I expand all fieldsets
