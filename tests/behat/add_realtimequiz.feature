...
Feature: Add a realtimequiz
  In order to evaluate students
  As a teacher
  I need to create a realtimequiz
  ...
  Background:
    ...
    And I add a "True/False" question to the "Test realtimequiz name" realtimequiz with:
  ...
  Scenario: Add and configure small realtimequiz and perform an attempt as a student with Javascript enabled
  ...
  Scenario: Add and configure small realtimequiz and perform an attempt as a student with Javascript disabled
