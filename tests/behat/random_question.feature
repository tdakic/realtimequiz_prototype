...
Feature: Moving a question to another category should not affect random questions in a realtimequiz
  In order for a realtimequiz with random questions to work as expected
  Teachers should be able to
  Move a question to a different category without affecting the category the random questions in the realtimequiz reference to
  ...
  Scenario: Moving a question should not change the random question
    ...
    And I should see "Random (Used category)" on realtimequiz page "1"
  ...
  Scenario: Renaming a random question category should update the random question
    ...
    And I am on the "Quiz 1" "mod_realtimequiz > Edit" page
    And I should see "Random (Used category new)" on realtimequiz page "1"
