...
Feature: Edit realtimequiz marks with attempts
  In order to create a realtimequiz that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit realtimequiz page (even after the realtimequiz has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz       | Quiz 1 | C1     | realtimequiz1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I add a "True/False" question to the "Quiz 1" realtimequiz with:
    ...
    And I add a "True/False" question to the "Quiz 1" realtimequiz with:
      ...
      | Default mark  | 3.0             |
    And I log out
    And I am on the "Quiz 1" "mod_realtimequiz > View" page logged in as "student1"
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the realtimequiz settings say it should be.
    ...
    When I am on the "Quiz 1" "realtimequiz activity editing" page
