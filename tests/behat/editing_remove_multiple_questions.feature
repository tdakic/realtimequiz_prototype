...
Feature: Edit realtimequiz page - remove multiple questions
  In order to change the layout of a realtimequiz I built efficiently
  As a teacher
  ...
  Scenario: Delete selected question using select multiple items feature.
    ...
    Then I should see "Info" on realtimequiz page "1"
    And I should see "Question A" on realtimequiz page "1"
    And I should not see "Question B" on realtimequiz page "1"
    And I should see "Question C" on realtimequiz page "2"
  ...
  # Confirm the starting point.
    Then I should see "Question A" on realtimequiz page "1"
    And I should see "Question B" on realtimequiz page "2"
    And I should see "Question C" on realtimequiz page "2"
    And I should see "Total of marks: 3.00"
    And I should see "Questions: 3"
    And I should see "This realtimequiz is open"
  ...
  # Delete first question in first page. Page contains multiple questions. No reordering.
    ...
    Then I should not see "Question A" on realtimequiz page "1"
    And I should see "Question B" on realtimequiz page "1"
  ...
  Scenario: Delete multiple questions from sections
    ...
    Then I should see "Question A" on realtimequiz page "1"
    And I should see "Question B" on realtimequiz page "2"
    And I should see "Question D" on realtimequiz page "3"
  ...
  Scenario: Delete multiple random questions from sections.
    ...
    Then I should see "Random (Test questions)" on realtimequiz page "1"
    And I should not see "Random (Test questions)" on realtimequiz page "2"
    And I should not see "Random (Test questions)" on realtimequiz page "3"
  ...
  Scenario: Delete all random questions by checking select all.
    ...
    And I click on "Yes" "button" in the "Confirm" "dialogue"
     # To make sure question is deleted completely.
    And I reload the page
    Then I should not see "Random (Test questions)" on realtimequiz page "1"
    And I should not see "Random (Test questions)" on realtimequiz page "2"
    And I should not see "Random (Test questions)" on realtimequiz page "3"
    And I should see "Total of marks: 0.00"
    And I should see "Questions: 0"
