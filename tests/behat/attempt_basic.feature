...
Feature: Attempt a realtimequiz
  As a student
  In order to demonstrate what I know
  I need to be able to attempt realtimequizzes
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz     | Quiz 1 | Quiz 1 description | C1     | realtimequiz1    | 100   | free       |
      | realtimequiz     | Quiz 2 | Quiz 2 description | C1     | realtimequiz2    | 6     | free       |
      | realtimequiz     | Quiz 3 | Quiz 3 description | C1     | realtimequiz3    | 100   | free       |
      | realtimequiz     | Quiz 4 | Quiz 4 description | C1     | realtimequiz4    | 100   | sequential |
    ...
    And realtimequiz "Quiz 2" contains the following sections:
      ...
      |           | 4         | 1       |
      | Section 3 | 5         | 1       |
    And realtimequiz "Quiz 3" contains the following questions:
      | question | page |
      | TF1      | 1    |
      | TF2      | 2    |
    And realtimequiz "Quiz 4" contains the following questions:
      | question | page |
      | TF1      | 1    |
      | TF2      | 2    |

  @javascript
  Scenario: Attempt a realtimequiz with a single unnamed section, review and re-attempt
  ...
  @javascript
  Scenario: Attempt a realtimequiz with multiple sections
    Given I am on the "Quiz 2" "mod_realtimequiz > View" page logged in as "student"
    When I press "Attempt realtimequiz"
    ...
    And I should see question "4" in section "Untitled section" in the realtimequiz navigation
    And I should see question "5" in section "Section 3" in the realtimequiz navigation
    And I should see question "6" in section "Section 3" in the realtimequiz navigation
    ...
    And I should see question "5" in section "Section 3" in the realtimequiz navigation
    And I should see question "6" in section "Section 3" in the realtimequiz navigation
    And I should see "Section 1" in the "realtimequizsummaryofattempt" "table"
    And I should see "Section 2" in the "realtimequizsummaryofattempt" "table"
    And I should see "Untitled section" in the "realtimequizsummaryofattempt" "table"
    And I should see "Section 3" in the "realtimequizsummaryofattempt" "table"
  ...
  Scenario: Next and previous navigation
    Given I am on the "Quiz 3" "mod_realtimequiz > View" page logged in as "student"
    When I press "Attempt realtimequiz"
  ...
  Scenario: Next and previous with sequential navigation method
    Given I am on the "Quiz 4" "mod_realtimequiz > View" page logged in as "student"
    When I press "Attempt realtimequiz"
    Then I should see "First question"
    And I should not see "Second question"
    And I press "Next page"
  ...
  @javascript
  Scenario: Take a realtimequiz with number of attempts set
    Given the following "activities" exist:
      | activity | name   | course | grade | navmethod  | attempts |
      | realtimequiz     | Quiz 5 | C1     | 100   | free       | 2        |
    And the following "questions" exist:
      | questioncategory | qtype       | name  | questiontext    |
      | Test questions   | truefalse   | TF7   | First question  |
    And realtimequiz "Quiz 5" contains the following questions:
      | question | page |
      | TF7      | 1    |
    And user "student" has attempted "Quiz 5" with responses:
      | slot | response |
      |   1  | True     |
    When I am on the "Quiz 5" "mod_realtimequiz > View" page logged in as "student"
    ...
    And I click on "Submit all and finish" "button" in the "Submit all your answers and finish?" "dialogue"
    And I follow "Finish review"
    And I should not see "Re-attempt realtimequiz"
