...
Feature: Teachers can override the grade for any question
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz       | Quiz 1 | Quiz 1 description | C1     | realtimequiz1    | 20    |
    ...
    And the following "user private files" exist:
      ...
      | teacher1 | mod/realtimequiz/tests/fixtures/moodle_logo.jpg | moodle_logo.jpg |
  ...
  Scenario: Validating the marking of an essay question attempt.
    When I am on the "Quiz 1 > student1 > Attempt 1" "mod_realtimequiz > Attempt review" page logged in as "teacher1"
  ...
  Scenario: Comment on a response to an essay question attempt.
    ...
    And I am on the "Quiz 1 > student1 > Attempt 1" "mod_realtimequiz > Attempt review" page
    And I follow "Make comment or override mark"
    And I switch to "commentquestion" window
