...
Feature: Edit realtimequiz marks with no attempts
  In order to create a realtimequiz that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit realtimequiz page.
  ...
  Scenario: Verify the number of decimal places shown is what the realtimequiz settings say it should be.
    ...
    And I am on the "Quiz 1" "realtimequiz activity editing" page
