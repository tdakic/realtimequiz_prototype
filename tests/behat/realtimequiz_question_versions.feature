...
Feature: Quiz question versioning
  ...
  As a teacher
  I need to be able to choose which versions can be displayed in a realtimequiz
  ...
  Scenario: Appropriate question version should be displayed when not edited
    When I am on the "Quiz 1" "mod_realtimequiz > Edit" page logged in as "teacher"
  ...
  Scenario: Appropriate question version displayed when later draft version exists
    ...
    And I am on the "Quiz 1" "mod_realtimequiz > View" page
  ...
  Scenario: Creating a new question should have always latest in the version selection
    ...
    And I set the following fields to these values:
      ...
      | Question text   | Write 200 words about realtimequizzes. |
    And I press "id_submitbutton"
    And I should see "New essay" on realtimequiz page "1"
  ...
  Scenario: Adding a question from question bank should have always latest in the version selection
    ...
    Then I should see "Other question" on realtimequiz page "1"
  ...
  Scenario: Adding a question where all available versions are drafts should display a helpful message.
    Given realtimequiz "Quiz 1" contains the following questions:
      | question       | page |
      | First question | 1    |
    And I am on the "Quiz 1" "mod_realtimequiz > Question bank" page logged in as teacher
    And I set the field "question_status_dropdown" in the "First question" "table_row" to "Draft"
    When I am on the "Quiz 1" "mod_realtimequiz > Edit" page
    Then I should see "This question is in draft status. To use it in the realtimequiz, go to the question bank and change the status to ready."
