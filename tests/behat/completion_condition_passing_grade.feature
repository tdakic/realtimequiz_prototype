...
Feature: Set a realtimequiz to be marked complete when the student passes
  In order to ensure a student has learned the material before being marked complete
  As a teacher
  I need to set a realtimequiz to complete when the student recieves a passing grade
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz     | Test realtimequiz name | C1     | realtimequiz1    | 4        | 5.00      | 2          | 1                  | 1                   | 1              |
  ...
  Scenario: student1 passes on the first try
    ...
    And the "View" completion condition of "Test realtimequiz name" is displayed as "todo"
    ...
    And the "Receive a passing grade" completion condition of "Test realtimequiz name" is displayed as "done"
  ...
  Scenario Outline: Verify that gradepass, together with completionpassgrade are validated correctly
    ...
    And the following "activity" exist:
      ...
      | realtimequiz     | Oh, grades, passgrades and floats| C1     | ohgrades | <gradepass>| 2          | <completionpassgrade> |
    When  I am on the "ohgrades" "realtimequiz activity editing" page logged in as "teacher1"
