...
Feature: Activity completion in the realtimequiz activity with unlocked and re-grading.
  In order to have visibility of realtimequiz completion requirements
  As a student
  I need to be able to view my realtimequiz completion progress even teacher have re-grading the grade pass.
  ...
  Scenario: Student will receive correct completion even when teacher unlocked completion and re-grading.
    Given I am on the "Test realtimequiz name" "realtimequiz activity" page logged in as student1
    ...
    And I am on the "Test realtimequiz name" "realtimequiz activity" page
    ...
    And I log out
    And I am on the "Test realtimequiz name" "realtimequiz activity" page logged in as student1
    And the "Receive a grade" completion condition of "Test realtimequiz name" is displayed as "done"
