...
Feature: Quiz group override
  In order to grant a group special access to a realtimequiz
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | realtimequiz     | Test realtimequiz | Test realtimequiz description | C1     | realtimequiz1    | 1         |

  Scenario: Override Group 1 as teacher of Group 1
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test realtimequiz" "mod_realtimequiz > Group overrides" page logged in as "teacher1"
  ...
  Scenario: Add button disabled if there are no groups
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    When I am on the "Test realtimequiz" "mod_realtimequiz > Group overrides" page logged in as "teacher3"
  ...
  Scenario: A teacher with accessallgroups permission should see all group overrides
    Given the following "mod_realtimequiz > group overrides" exist:
      ...
      | Test realtimequiz | G1    | 2        |
      | Test realtimequiz | G2    | 2        |
    When I am on the "Test realtimequiz" "mod_realtimequiz > View" page logged in as "teacher1"
  ...
  Scenario: A teacher without accessallgroups permission should only see the group overrides within his/her groups, when the activity's group mode is "separate groups"
    Given the following "permission overrides" exist:
      | capability                  | permission | role           | contextlevel | reference |
      | moodle/site:accessallgroups | Prevent    | editingteacher | Course       | C1        |
    And the following "mod_realtimequiz > group overrides" exist:
      | realtimequiz      | group | attempts |
      | Test realtimequiz | G1    | 2        |
      | Test realtimequiz | G2    | 2        |
    When I am on the "Test realtimequiz" "mod_realtimequiz > View" page logged in as "teacher1"
  ...
  Scenario: A non-editing teacher can see the overrides, but not change them
    Given the following "mod_realtimequiz > group overrides" exist:
      ...
      | Test realtimequiz | G1    | 2        |
      | Test realtimequiz | G2    | 2        |
    When I am on the "Test realtimequiz" "mod_realtimequiz > Group overrides" page logged in as "helper"
    Then "Group 1" "table_row" should exist
    And "Group 2" "table_row" should exist
  ...
  Scenario: "Not visible" groups should not be available for group overrides
    ...
    When I am on the "realtimequiz1" Activity page logged in as teacher1
